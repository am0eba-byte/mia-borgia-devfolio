...
import { faAngular, faPython, faAws, faDocker, faJira } from '@fortawesome/free-brands-svg-icons';
import { faDatabase, faVial, faToolbox } from '@fortawesome/free-solid-svg-icons';
